                                ...
                                $.ajax({
                                    ...
                                    complete: function (result) {
                                        if (result.status === 200) {
                                            ...
                                            $Middle.find('.Middle-searchHeader').text('Найден' + (result.responseJSON.count % 10 == 1 && result.responseJSON.count % 100 != 11 ? 'а ' : 'о ')  +
                                                result.responseJSON.count + ' книг' +
                                                (result.responseJSON.count % 10 === 1 && result.responseJSON.count % 100 != 11 ? 'a' : (result.responseJSON.count % 10 > 1 && result.responseJSON.count % 10 < 5 && (result.responseJSON.count < 10 || result.responseJSON.count > 20) ? 'и' : '') ))
                                ...
                                postData('/login', $this.data('send'), function (result) {
                                    if (result != null && result.result) {
                                        ...
                                        if (result) {
                                            ...
                                            $thisStep.find('.form-input:not(.form-input_hide)[type="text"]').addClass('form-input_error').after('<div class="form-error">' + 'Пользователь не найден или введен неверный логин\/пароль' + '</div>');
                                        }
                                    }
                                })
                            } else {
            ...
            return {
                init: function () {
                    ...
                    $ProductAssesment.find('.Rating input').on('change', function (e) {
                        ...
                        Login().postData('/books/changeBookStatus/rating/' + $this.closest('.Rating').data('bookid'), {
