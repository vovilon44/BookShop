...
class MainPageControllerTests
{
    ...
    @Test
    public void mainPageAccesTest() throws Exception
    {
        mockMvc.perform(get("/"))
                .andDo(print())
    ...
    public void correctLoginTest() throws Exception {
        mockMvc.perform(formLogin("/signin").user("aaaa@aa.aa").password("332233"))
                .andDo(print())
                .andExpect(status().is3xxRedirection())
    ...
    public void testSearchQuery() throws Exception {
        mockMvc.perform(get("/search/lly"))
                .andDo(print())
                .andExpect(xpath("/html/body/div/div/main/div[2]/div/div[8]/div[2]/strong/a")
                        .string("What Price Hollywood?"));
    }
}